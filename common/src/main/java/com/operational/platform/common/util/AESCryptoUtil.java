...
public class AESCryptoUtil {
    ...
    private static String seed = "vip.com.key.888";
    ...
    public static String encrypt(String str) throws CryptoException {
        if (!StringUtils.isEmpty(str)) {
            try {
                ...
                byte[] bs = ecipher.doFinal(str.getBytes(charset));// 加密
    ...
    public static void main(String[] args) throws CryptoException {
        ...
        System.out.println(AESCryptoUtil.encrypt(StrUtil.getRandomString(32) + System.currentTimeMillis()));
    }
}
