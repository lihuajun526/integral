...
import com.operational.platform.dbservice.service.BreakRuleService;
import com.operational.platform.dbservice.service.CrawlPointService;
import com.operational.platform.taskbreak.entity.SourceRoot;
...
public class RulesLoader {
    ...
    public static void load() {
        ...
        for (CrawlPoint crawlPoint : crawlPointList) {
            ...
            /***** 分解规则 *****/
            List<com.operational.platform.dbservice.model.BreakRule> modelBreakRuleList = breakRuleService
                    .getByCrawlId(crawlPoint.getId());

            List<BreakRule> breakRuleList = new ArrayList<>();

            for (com.operational.platform.dbservice.model.BreakRule breakRule : modelBreakRuleList) {
