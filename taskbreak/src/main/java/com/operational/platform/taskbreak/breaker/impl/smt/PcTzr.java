...
public class PcTzr extends ABreaker {
    ...
    public void exe(BreakTask breakTask, Map<String, String> attr) throws CommonException {
        ...
        List<String> cookies = new ArrayList<String>() {{
            add("JSESSIONID=D445273FDCC77DFAD8D5628721197C22; USER_LOGIN_ID=e118f9f3480740fc88fb49ed99e5e854; USER_LOGIN_NAME_KEY=e118f9f3480740fc88fb49ed99e5e854; IS_CS_KEY=true; USER_LOGIN_NAME=13002664859; USER_LOGIN_LANGUAGE=zh_CN; USER_CLIENT_ID=\"\"; firstEnterUrlInSession=http%3A//pe.pedata.cn/getIndexHome.action; VisitorCapacity=1; operatorId=31183; pageReferrInSession=http%3A//pe.pedata.cn/getListPerson.action; request_locale=zh_CN");
        }};
        ...
        try {
            ...
            int pageCount = getPageCount(doc, attr);
    ...
    private void saveAll(List<Investor> investorList, Map<String, String> attr) throws InterruptedException, RequestException, URISyntaxException {
        ...
        httpGet.setHeader("Cookie", "JSESSIONID=D445273FDCC77DFAD8D5628721197C22; USER_LOGIN_ID=e118f9f3480740fc88fb49ed99e5e854; USER_LOGIN_NAME_KEY=e118f9f3480740fc88fb49ed99e5e854; IS_CS_KEY=true; USER_LOGIN_NAME=13002664859; USER_LOGIN_LANGUAGE=zh_CN; USER_CLIENT_ID=\"\"; firstEnterUrlInSession=http%3A//pe.pedata.cn/getIndexHome.action; VisitorCapacity=1; operatorId=31183; pageReferrInSession=http%3A//pe.pedata.cn/getListPerson.action; request_locale=zh_CN");
