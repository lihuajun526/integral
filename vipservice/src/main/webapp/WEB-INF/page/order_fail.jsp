...
<head>
    ...
    <link rel="stylesheet" href="/statics/order_success/lucky_money_list_d666f68e1491b53a8fd772d64023e4b6.css"
          onerror="_cdnFallback(this)" media="screen">
    <script charset="utf-8" src="/statics/order_success/common_08b03c7826.js"></script>
    <script charset="utf-8" src="/statics/order_success/base_33619a7a85.js"></script>
    <script charset="utf-8" src="/statics/order_success/u_b.js"></script>
    <script charset="utf-8" src="/statics/order_success/lucky_money_db6cc574aa.js"></script>
    <script charset="utf-8" async="" src="/statics/order_success/hm.js"></script>
</head>
<body class=" ">

<div class="container " style="min-height: 513px;">
    <div class="content">
        <div id="lucky-list-container" class="block block-list" style="margin-top: 10px;">
            <div class="js-list b-list"></div>
            <div class="empty-list list-finished" style="margin-top:30px;">
                <div>
                    <h4>下单失败</h4>

                    <p class="font-size-12"><%=errMsg %>
                    </p>
                </div>
                <%
                    if (errCode.equals("000003")) {
                %>
                <a href="https://wap.koudaitong.com/v2/showcase/homepage?kdt_id=17984819"
                   class="tag tag-big tag-red js-goto-homepage" style="padding:8px 20px;">点击充值</a>
                <%
                } else {
                %>
                <a href="https://wap.koudaitong.com/v2/showcase/homepage?kdt_id=17984819"
                   class="tag tag-big tag-red js-goto-homepage" style="padding:8px 20px;">返回首页</a>
                <%
                    }
                %>
            </div>
