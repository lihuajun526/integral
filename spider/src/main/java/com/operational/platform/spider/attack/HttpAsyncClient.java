 ...
 * All rights reserved.
 */
package com.operational.platform.spider.attack;


import com.operational.platform.spider.util.cookie.IgnoreCookieStore;
import com.operational.platform.spider.util.cookie.IgnoreRedirect;
import com.operational.platform.spider.util.cookie.PerfMonitor;
    ...
    private static void initHttpAsyncClient() {
        try {
            ...
            SSLIOSessionStrategy sslSessionStrategy = new SSLIOSessionStrategy(sslcontext,
                    new String[] { "TLS", "SSLv3.0", "TLSv1" }, null,
